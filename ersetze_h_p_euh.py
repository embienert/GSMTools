...
mit_euh_list = ["EUH014", "EUH018", "EUH019", "EUH029", "EUH031", "EUH032", "EUH044", "EUH066", "EUH070", "EUH071", "EUH201", "EUH201A", "EUH202", "EUH203", "EUH204", "EUH205", "EUH206", "EUH207", "EUH208", "EUH209", "EUH209A", "EUH210", "EUH211", "EUH212", "EUH401"]
...
print()
print("\n" +"Prüft, ob die H-, P- und EUH-Sätze mit den jeweiligen Buchstaben beginnen.")


def plus_buchstabe(spalte, ohne_list, mit_list):
    print("\n\n\n  ANFANG")
    row_counter = 3
    ...
    for row in ws.iter_rows(min_row=3, max_row = max_row+1, values_only=True):  # , values_only=True
        ...
        if "keine Angabe" in h or "k.A." in h:
            print(h)
            continue
...
if plus_buchstabe(8, ohne_h_list, mit_h_list) == 0:
    print("Alle H-Sätze beginnen bereits mit H.")
    
if plus_buchstabe(9, ohne_p_list, mit_p_list) == 0:
    print("Alle P-Sätze beginnen bereits mit P.")
    
if plus_buchstabe(10, ohne_euh_list, mit_euh_list) == 0:
